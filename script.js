document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById("search-input").addEventListener("input", function () {
    ...
    let filteredTasks = todoList.filter(task => task.title.toLowerCase().includes(query));
...
function renderTasks(tasks) {
  ...
  completedTasksHeader.classList.add("d-flex", "justify-content-between", "align-items-center", "mb-3", "flex-wrap", "top-ctn");
  ...
  clearButton.classList.add("btn", "btn-light", "border-1", "border-primary", "text-primary", "ml-3");
  ...
  tasks.forEach((task) => {
    ...
    flexContainer.classList.add("d-flex", "justify-content-between", "div-gap");
    ...
    badge.classList.add("badge", task.completed ? "badge-success" : "badge-warning", "ml-2");
